...
class TestDateconversion:
    ...
    def test_returns_failure_if_date_is_not_present(self):
...
class TestIntFromstring:
    ...
    def test_returns_failure_if_int_is_not_present(self):
        assert_that(int_from_string.parse_from(None, success_attribute='some_int'), equal_to(Failure(message="some_int is missing")))
